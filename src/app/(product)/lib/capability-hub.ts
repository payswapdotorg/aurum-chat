...
export const CAPABILITY_FAMILIES: readonly CapabilityFamily[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        id: 'provider-choice',
        label: 'Say what matters when Aurum picks AI',
        summary:
          'Privacy, cost, speed or reliability — choose in plain words, change it any time, and see why each choice was made. Technical settings stay in advanced.',
