...
export const CAPABILITY_FAMILIES: readonly CapabilityFamily[] = [
  ...
  },
  {
    ...
    blurb: 'What matters when Aurum picks AI — and bringing your own AI accounts.',
    entries: [
      {
        id: 'ai-preferences',
        label: 'Choose what matters when Aurum uses AI',
        summary:
      ...
      },
      {
        ...
        summary:
          'For authorized administrators: technical provider detail, reversible provider pins per AI route, and the full record of every choice.',
        ...
        icon: 'developer',
        note: 'authorized administrators',
      },
    ],
  },
  {
